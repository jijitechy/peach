  ...
  return (
    <div className="max-w-5xl mx-auto pb-10">
      ...
      <div className="flex items-center justify-center mb-10 max-w-2xl mx-auto">
        <div className="flex items-center text-[#FF6B35] font-bold text-sm">
          <div className="w-6 h-6 rounded-full bg-[#FF6B35] text-white flex items-center justify-center mr-2 text-xs">1</div>
          Upload Product
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 border-r border-gray-100 bg-gray-50/50 flex flex-col items-center justify-center min-h-[400px]">
            <div className="w-full max-w-sm aspect-[4/3] bg-white border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center p-6 text-center cursor-pointer hover:border-[#FF6B35] hover:bg-orange-50 transition-colors group relative overflow-hidden">
          ...
          <div className="p-8 relative">
            <div className="absolute top-4 right-4 bg-orange-100 text-[#FF6B35] px-3 py-1 rounded-full flex items-center gap-1.5 text-[10px] font-black tracking-wider uppercase border border-orange-200">
              <Sparkles className="w-3 h-3" /> AI PRE-FILL ACTIVE
            </div>

            <div className="mb-6 mt-2">
              <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-orange-100 text-[#FF6B35] flex items-center justify-center font-bold text-sm">AI</div>
                AI is Analyzing Your Product...
              </h3>
              <div className="mt-4 space-y-2 text-sm text-gray-600">
                <p className="flex items-center gap-2"><span className="text-[#FF6B35]">✓</span> Identifying product details...</p>
                <p className="flex items-center gap-2"><span className="text-[#FF6B35]">✓</span> Detecting brand and model...</p>
                <p className="flex items-center gap-2"><span className="text-[#FF6B35]">✓</span> Extracting specifications...</p>
                <p className="flex items-center gap-2"><span className="text-[#FF6B35]">✓</span> Generating description...</p>
              </div>
            </div>
            ...
            <div className="space-y-5 text-sm">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" className="w-full border-b border-gray-200 py-1 font-medium text-gray-900 focus:outline-none focus:border-[#FF6B35] bg-transparent" defaultValue="HP EliteBook 840 G5 - Core i7, 16GB RAM, 512GB SSD - Business Laptop" />
                </div>
                <div>
                  <label className="block text-[10px] font-bold text-gray-500 uppercase mb-1">Category</label>
                  <select className="w-full border-b border-gray-200 py-1 font-medium text-gray-900 focus:outline-none focus:border-[#FF6B35] bg-transparent">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" className="w-full border-b border-gray-200 py-1 font-medium text-gray-900 focus:outline-none focus:border-[#FF6B35] bg-transparent" defaultValue="HP" />
                </div>
              </div>

              <div>
                <label className="block text-[10px] font-bold text-gray-500 uppercase mb-1">Product Description</label>
                <textarea rows={4} className="w-full border border-gray-200 rounded-lg p-3 text-sm text-gray-700 focus:outline-none focus:border-[#FF6B35] bg-gray-50/50 resize-none" defaultValue="The HP EliteBook 840 G5 is a premium business laptop designed for performance and reliability. Powered by an Intel Core i7 processor, 16GB RAM and 512GB SSD, it delivers fast and smooth performance for work, study and everyday use. With its slim and durable design, long battery life and professional build quality, it's the perfect laptop for business users and students." />
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <input type="text" className="w-full border-b border-gray-200 py-1 font-black text-orange-900 text-lg focus:outline-none focus:border-[#FF6B35] bg-transparent" defaultValue="KES 28,000 - 32,000" />
                  </div>
                  <div className="mt-4">
              ...
              <div className="pt-6 mt-6 border-t border-gray-100 flex justify-end">
                <button className="bg-[#FF6B35] hover:bg-[#e85a24] text-white px-8 py-3 rounded-xl text-sm font-bold shadow-md shadow-orange-600/20 flex items-center gap-2 transition-colors">
